        ...
        .then((data) => {
          if (data !== null) {
            let note = {
              ...
              // labels: {
              //   _id:
              //     editObject.noteId === editObject.noteId
              //       ? editObject.noteId
              //       : data.noteId,
              //   label:
              //     editObject.label === editObject.label
              //       ? editObject.label
              //       : data.label,
              // },
            };
            ...
            if (data[0].collaborator.length !== 0) {
              for (let i = 0; i < data[0].collaborator.length; i++) {
                if (
                  ...
                  logger.info(
                    "data after splice=======>" + data[0].collaborator
                  );
