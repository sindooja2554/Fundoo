...
describe('/DeleteNote deleteNote', () => {
    // it('Successfully deleting notes', (done) => {
    //     chai.request(server)
    //         .delete('/note/' + createNoteObject.noteId[1].noteId)
    ...
    //     chai.request(server)
    //         .delete('/note/' +  createNoteObject.noteId[2].noteId)
    //         .set('token', createNoteObject.loginToken[0].token)
    //         .end((err, res) => {
